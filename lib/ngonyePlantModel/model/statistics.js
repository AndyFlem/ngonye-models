...
export default function statistics(parameters, dys, fast) {
  ...
  statistics.Skew = (statistics.EnergyAnnual_P50 - statistics.EnergyAnnual_mean)/statistics.EnergyAnnual_mean
  
  return {fdc, daily,weekly, monthly, yearly, calendarYearly, calMonthly, calMonthlyEnergyExceedances, dailyExceedances, monthlyExceedances, annualExceedances, statistics}
}
